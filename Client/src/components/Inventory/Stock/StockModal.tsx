        ...
        <Modal.Body>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group>
              ...
              <Form.Control as="textarea" id="description" name="description" value={formData.description} onChange={handleChange} required />
            </Form.Group>
      ...
      <option key={supplier.id} value={supplier.id}>
        {supplier.name}
            ...
            <Form.Group>
              ...
              <Form.Control type="number" id="quantity" name="quantity" value={formData.quantity} onChange={handleChange} required />
            </Form.Group>

            <Form.Group>
              <Form.Label>Cost:</Form.Label>
              <Form.Control type="number" id="cost" name="cost" value={formData.cost} onChange={handleChange} required />
            </Form.Group>

            <Form.Group>
              <Form.Label>Image:</Form.Label>
              <Form.Control type="file" id="image" name="image" onChange={handleChange} required />
            </Form.Group>

            <Form.Group>
              <Form.Label>Arrival Date:</Form.Label>
              <Form.Control type="date" id="arrivalDate" name="arrivalDate" value={formData.arrivalDate} onChange={handleChange} required />
            </Form.Group>

...
export default function SupportButton(){
    ...
    return(
        ...
        <div className='row'>
          ...
          <button type="button" className="btn btn-outline-primary" style={{border:'1px solid #482890',color:'#482890'}}>Export to excel</button>
          </div>
          <div className='col-2' style={{padding:'0 0 0 20px'}}>
          <button onClick={handleShow} type="button" className="btn btn-outline-light" style={{backgroundColor:'#FF615A'}} >+ New Ticket</button>
          </div>

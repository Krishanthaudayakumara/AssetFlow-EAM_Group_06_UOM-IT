...
const AgentTable = () => {
  ...
  const handleUpdateAgent = () => {
    axios
      .put(
        `http://localhost:5224/Api/Agent/${selectedAgent?.id}`, selectedAgent )
      .then((response) => {
        setAgents(
          agents.map((agent) =>
              ...
              <tbody>
                {agents.map((agent) => (                      
                        <tr key={agent.id} >
                          ...
                          <td> <FontAwesomeIcon icon={faPen} style={{ color: "#482890", cursor: "pointer" }} onClick={() => handleEditAgentClick(agent)} />
                                &nbsp; &nbsp; &nbsp;
                               <FontAwesomeIcon icon={faTrash}  style={{ color: "#FF615A", cursor: "pointer" }} /></td> 
                        </tr>                      
                    ))}
              </tbody>
            </Table>           
        ...
        {selectedAgent && (
          <>
            ...
            <Modal.Body>
              ...
              <p>Agent ID: {selectedAgent.id}</p> <p>Join Date: {selectedAgent.joinDate}</p>
              <Form>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  onChange={(e) => setSelectedAgent({ ...selectedAgent, contact: e.target.value,})} />
              </Form.Group>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  onChange={(e) => setSelectedAgent({ ...selectedAgent, position: e.target.value,})} />
              </Form.Group>
              <Form.Group>
              ...
              <Form.Group>
                ...
                <Form.Control
                  ...
                  onChange={(e) => setSelectedAgent({ ...selectedAgent, teamId: Number(e.target.value),})} />
              </Form.Group>
              <Form.Group>
